...
| v1.0.4 | the README opens with the problem ocm solves, a comparison and a 30-second try-it; LICENSE file; npm metadata linking back to GitHub. Docs and metadata only | published 2026-09-24 |
